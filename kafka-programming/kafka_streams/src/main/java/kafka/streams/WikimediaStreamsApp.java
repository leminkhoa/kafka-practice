...
import kafka.streams.processor.BotCountStreamBuilder;
import kafka.streams.processor.EventCountTimeseriesBuilder;
import kafka.streams.processor.WebsiteCountStreamBuilder;
...
public class WikimediaStreamsApp {
    ...
    static {
        ...
        properties.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "127.0.0.1:9093");
